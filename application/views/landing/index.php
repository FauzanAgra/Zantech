...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
        <div class="container">
            <a class="navbar-brand js-scroll-trigger" href="#page-top">ZANTECH</a>
    ...
    <header class="masthead">
        <div class="container">
            <div class="masthead-subheading">Welcome To Movies Studio!</div>
            <div class="masthead-heading text-uppercase">It's Nice To Meet You</div>
            <a class="btn btn-primary btn-xl text-uppercase js-scroll-trigger" href="<?= base_url('auth/registrasion'); ?>">Register Now</a>
        </div>
    </header>
    <!-- Services-->
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="team-member">
                        ...
                        <h4>Fauzan Agra</h4>
                        <p class="text-muted">Chief Executife Officer</p>
    ...
    <div class="portfolio-modal modal fade" id="portfolioModal1" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="close-modal" data-dismiss="modal"><img src="<?= base_url(); ?>assets/img/close-icon.svg" alt="Close modal" />
                </div>
                <div class="container">
